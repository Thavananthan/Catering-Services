   ...
   if(isset($_POST["login"])) 
   {
      ...
      //conditions
       ...
       //if username entered not yet exists
		  ...
		  echo '<script type="text/javascript">alert("The username you entered is invalid.");</script>';
        }
        else {
          //if exists, then extract the password.
             while($row_query = mysqli_fetch_array($query_result)) {
              // check if password are equal
             if($row_query['password']==$_POST["password_l"]){
                  $_SESSION['pass'] = $_POST['password_l'];
			      $_SESSION["email"]= $_POST["email_l"];
