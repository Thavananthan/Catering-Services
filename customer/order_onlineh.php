 ...
 <body>
		 ...
		 <!-- header start -->  
				...
				<div id="menu">
                     ...
                     <div class="order">
					        <b id="fcolor"> LET'S GO </b>
                           <div class="box1">
						     <br> <img src="photos/guest.jpg" height="300px" width="350px"> <br><br>
					<center> <a href="Registerh.php"> <b id="guest"> GUEST CHECK OUT </a></b>
							  
						   
						   </div>
                         
							<div class="box1">
							<img src="photos/memberh.jpg" height="300px" width="350px"><br><br>
				<center>  <a href="login.php"><b id="guest"> MEMBER LOGIN </a> </b>
